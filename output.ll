...
@.str1 = private constant [10 x i8] c"holaaaaaa\00"
define i8 @f(i32 %cont_num, i32 %cont_NUM2, i8 %cont_caracter, i8* %cont_cadena) {
entry:
    %f = alloca i8
    %num = alloca i32
...
define i32 @main() {
    %x = alloca i8
    call void @write_string(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str1, i32 0, i32 0))
%ptr_cadena12 = bitcast [5 x i8]* @cadena12 to i8*
    %x_val11 = call i8 @f(i32 3, i32 2, i8 99, i8* %ptr_cadena12)
    call void @write_string(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str2, i32 0, i32 0))
    call void @write_char(i8 %x_val11)
  ret i32 0
}
